<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
            <form action="<?php echo e(route('update-poli',['id'=>$data->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
                            ...
                            <form>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_poli" class="form-control" id="exampleInputPoli1" value="<?php echo e($data->nama_poli); ?>"
...
<?php echo $__env->make('components.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\poli\resources\views\admin\edit-poli.blade.php ENDPATH**/ ?>