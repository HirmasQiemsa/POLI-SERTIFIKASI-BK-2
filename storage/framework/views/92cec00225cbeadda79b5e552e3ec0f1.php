    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info d-flex">
                        <a href="#" class="d-flex">Hi, <?php echo e($dokter->nama); ?></a>
                    </div>
                </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="tree" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('periksa-pasien')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('jadwal-dokter')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('setting-dokter')); ?>" class="nav-link">
